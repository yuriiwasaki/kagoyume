<?php
$appid = "dj0zaiZpPUIyU3pOMUVmNDBHbyZzPWNvbnN1bWVyc2VjcmV0Jng9NGU-";
//app const =
const ROOT_URL ="http://localhost/kagoyume/app/top.php";
...
const DB_USERNAME ="yuri";
const DB_PASSWORD ="yuri1988";
const PDO_DSN ="mysql:host=localhost;dbname=".DATABASE.";charset=utf-8";
//API
 ...
 * @var string
 */
$appid = "dj0zaiZpPUIyU3pOMUVmNDBHbyZzPWNvbnN1bWVyc2VjcmV0Jng9NGU-";//取得したアプリケーションIDを設定
 ...
 * echo h("<>&'\""); //&lt;&gt;&amp;&#039;&quotと出力します。
 *
 * @param 引値　string $str 変換したい文字列
 *
 * @return 返り値　string html用に変換した文字列
 *defineUtil
 */
?>
